      ...
      <div className="px-2 py-3 border-b z-50 bg-background bg-opacity-0 sticky top-0 left-0 right-0 flex justify-between items-center">
        <div className="flex items-center gap-3">
          <Sheet className="">
            ...
            <SheetContent
              className="w-55  border-r-0 flexs flex-col  justify-center"
              side="left"
            >
              <SheetHeader>
                <SheetTitle>
                  <div className="text-3xl flex justify-center  items-center gap-1">
                    ...
                    <div>
                    <span className="font-bold text-purple-500">CRYPTAL</span>
                    </div>
                  </div>
                </SheetTitle>
              </SheetHeader>
          ...
          <p
  onClick={() => navigate("/")}
  className="text-sm lg:text-base cursor-pointer tracking-widest"
>
  CRYPTAL
</p>
<p
